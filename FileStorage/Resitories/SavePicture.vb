...
Namespace FileStorage
    Public Class Picture
        Public Function UploadImage(imgData As Byte(), Id As Integer, table As String) As Integer
            Dim connection As New SqlConnection("server=.; database=FilmPool; Trusted_Connection=True; TrustServerCertificate=Yes;")
            Dim command As New SqlCommand("UPDATE " + table + " SET Picture = @Image WHERE Id = @Id", connection)
